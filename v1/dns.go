...
// UnmarshallDNS parses the JSON-encoded data and stores the result in the value pointed to by d.
// It requires you to know the firmware version which this measurement was generated in.
func UnmarshalDNS(b []byte, fw int, d *DNS) error {
	var err error
...
func parseDNS(b []byte, d *DNS) error {
...
type DNS struct {
	...
	Resultset       []DNS      `json:"resusltset,omitempty"`
